...
import emote1 from '../assets/images/emote1.png'
        ...
        <>
            ...
            <div className="w-full h-full flex">
                <div className="flex flex-col gap-8 p-14 z-10">
                    ...
                    <Link to='about'>
                        <div>
                            <div className="px-5 py-4 w-1/2 items-center justify-center flex gap-2 rounded-full bg-gradient-to-r from-emerald-400 to-sky-400 hover:drop-shadow-2xl transition-all">
            ...
            <div className="text-8xl font-bold text-center bg-gradient-to-r from-emerald-400 to-sky-400 bg-clip-text text-transparent">
                精彩的操作
            </div>
            <div className="w-full border-y-2 mb-20 p-14"
                style={{backgroundImage: `url(${background})`}}
            >
                <video className="w-4/5 mx-auto" autoPlay muted src={home_video} loop></video>
            </div>
            <div className="text-8xl font-bold text-center bg-gradient-to-r from-emerald-400 to-sky-400 bg-clip-text text-transparent">近期MVP</div>
            <div className="flex p-14 border-y-2">
                <div className="w-3/5">
                    <video src={mvp_video} controls loop></video>
                </div>
                <div className="w-2/5 p-5 flex flex-col justify-between">
